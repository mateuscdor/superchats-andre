...
import { SocketConfig, ParticipantAction, Chat, GroupMetadata } from "../model";
import { BinaryNode, BinaryNodeAttributes } from '../bin';
...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    fetchBlocklist: () => Promise<BinaryNode>;
    ...
    chatModify: (mod: import("../model").ChatModification, jid: string, lastMessages: Pick<proto.IWebMessageInfo, "key" | "messageTimestamp">[]) => Promise<void>;
    resyncMainAppState: () => Promise<void>;
    assertSession: (jid: string, force: boolean) => Promise<boolean>;
    relayMessage: (jid: string, message: proto.IMessage, { messageId: msgId, additionalAttributes, cachedGroupMetadata }: import("../model").MessageRelayOptions) => Promise<string>;
    ...
    sendMessage: (jid: string, content: import("../model").AnyMessageContent, options?: import("../model").MiscMessageGenerationOptions) => Promise<proto.WebMessageInfo>;
