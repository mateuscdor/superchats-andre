...
import { MessageType, MessageOptions, WAChat, WAMessageContent, WAMessageProto, WAMessage, WAMessageKey, WAMediaUpload } from './variables';
...
export declare const Browsers: {
    ...
    WP: (browser: any) => [string, string, string];
...
export declare const newMessagesDB: (messages?: WAMessage[]) => FluidDB<WAMessageProto.WebMessageInfo, string>;
