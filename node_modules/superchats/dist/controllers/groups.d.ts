import { SuperChats as Base } from './messages_additional';
import { WANode, WAGroupMetadata, WAGroupCreateResponse, WAGroupModification } from './variables';
import { GroupSettingChange } from './variables';
export declare class SuperChats extends Base {
     ...
     * WP automatically caches & maintains this state
     */
