...
import WS from 'ws';
import Encoder from '../sys/crypt';
import Decoder from '../sys/decrypt';
import { Method } from 'got';
import { AuthenticationCredentials, WAUser, WANode, WATag, DisconnectReason, createState, AnyAuthenticationCredentials, WAContact, WAQuery, ReconnectMode, WAConnectOptions, MediaConnInfo } from './variables';
import { EventEmitter } from 'events';
import FluidDB from '../db/FluidDB';
import { Agent } from 'https';
import pino from 'pino';
export declare class SuperChats extends EventEmitter {
    ...
    chatOrderingKey: {
        key: (c: import("./variables").WAChat) => string;
    ...
    chats: FluidDB<import("./variables").WAChat, string>;
    contacts: {
        [k: string]: WAContact;
    };
    blocklist: string[];
