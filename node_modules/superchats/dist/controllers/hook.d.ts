import { create as Base } from './connect';
import { WAMessage, WAContact, WAChat, WA_MESSAGE_STATUS_TYPE, PresenceUpdate, WPEvent, DisconnectReason, WAOpenResult, WAParticipantAction, WAGroupMetadata, WAChatUpdate, BlocklistUpdate, WAContactUpdate } from './variables';
export declare class SuperChats extends Base {
    ...
    on(event: WPEvent | string, listener: (json: any) => void): this;
    emit(event: WPEvent | string, ...args: any[]): boolean;
}
